...
Version  : 23.08.2
Release  : 57
URL      : https://download.kde.org/stable/release-service/23.08.2/src/kolf-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kolf-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kolf-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kolf-23.08.2
cd %{_builddir}/kolf-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697245065
mkdir -p clr-build
pushd clr-build
