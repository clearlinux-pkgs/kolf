...
Version  : 23.08.4
Release  : 59
URL      : https://download.kde.org/stable/release-service/23.08.4/src/kolf-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kolf-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kolf-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kolf-23.08.4
cd %{_builddir}/kolf-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702952320
mkdir -p clr-build
pushd clr-build
