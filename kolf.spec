...
Source0  : https://download.kde.org/stable/release-service/20.04.1/src/kolf-20.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.1/src/kolf-20.04.1.tar.xz.sig
...
%prep
%setup -q -n kolf-20.04.1
cd %{_builddir}/kolf-20.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589841655
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kolf-20.04.1/COPYING %{buildroot}/usr/share/package-licenses/kolf/88d0ee521bcbddeff0f97979d84760ef8d1529cc
cp %{_builddir}/kolf-20.04.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kolf/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kolf-20.04.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kolf/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/kolf-20.04.1/external/COPYING %{buildroot}/usr/share/package-licenses/kolf/2968029980d16f3e4c5ca945099a747725a5eacb
pushd clr-build
%make_install
popd
%find_lang kolf
